...
$database = "u166970561_fordo"; //Databasen
$password = "Magnus70";


try {
		$dbh = new PDO('mysql:host=mysql.hostinger.se;dbname='.$database, 'u166970561_linnw', $password); //Försöker ansluta
...
foreach($smtp as $bilar){
     ...
     echo '<td>',$bilar['reg'],'</td>';    
     echo '<td>',$bilar['marke'],'</td>';          
